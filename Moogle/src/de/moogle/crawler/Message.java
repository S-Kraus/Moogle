...
public class Message{
	...
	public Message(String headTitle, String headLink, String headDescription, String title, String description, 
			String pubDate, String guid, String path, String extractedText) {
	...
	public Object clone() {
		Message clone = new Message(this.headTitle,this.headLink,this.headDescription,this.title,
				this.description,this.pubDate,this.guid,this.path,this.extractedText);
		return clone;
	}
